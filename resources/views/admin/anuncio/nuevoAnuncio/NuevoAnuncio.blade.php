...
<div class="page-content">
    <div class="row">
      ...
      {!! Form::select('idpelos',$pelos,null, $attributes = array('class'=>'form-control','id'=>'idpelos')) !!}
                </div>
            </div>
            <div class="row">
                <div class="form-group col-md-4">
                    {{ Form::label('Ojos', 'Ojos') }}
      {!! Form::select('idojos',$ojos,null, $attributes = array('class'=>'form-control','id'=>'idojos')) !!}
                </div>
            </div>
            <div class="row">
                <div class="form-group col-md-4">
                    {{ Form::label('Estatura', 'Estatura') }}
      {!! Form::select('idestatura',$estaturas,null, $attributes = array('class'=>'form-control','id'=>'idestatura')) !!}
                </div>
            </div>
            <div class="form-group">
