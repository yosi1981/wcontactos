    ...
    <div class="form-group col-md-8">
      ...
      {{ Form::label('Provincia1', 'Provincia') }}
      {!! Form::select('Provincia1',$provincias,$prodef, $attributes = array('class'=>'form-control','id'=>'Provincia1','multiple'=>'multiple')) !!}
...
<input type="hidden" id="idanuncioProgramado" name="idanuncioProgramado" value="{{$apl->idanuncioProgramado}}">
      {{ Form::label('Localidad1', 'Localidad') }}
      {!! Form::select('Localidad1',$locadef,$locas, $attributes = array('class'=>'form-control','id'=>'Localidad1','multiple'=>'multiple')) !!}
    </div>
  </div>
