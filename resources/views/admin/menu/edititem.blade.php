                ...
                <div class="col-xs-12">		
		                ...
		                <div class="row">
		                        <div class="form-group col-md-12">
										...
										{!! Form::select('imagen',$iconos[1],$icono, $attributes = array('class'=>'col-sm-7 form_control','id'=>'imagen')) !!}
