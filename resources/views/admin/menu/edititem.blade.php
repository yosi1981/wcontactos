                    ...
                    <div class="widget-main">			
						...
						<div class="row">
							<div class="col-lg-4 col-sm-4">
								<div class="form-group">
										<label>Titulo</label>
										<input type="text" name="Titulo" class="form-control" value="{{$menuitem->Titulo}}" id="Titulo" placeholder="Titulo...">
								</div>
							</div>
						</div>
						...
						<div class="row">
							<div class="col-lg-4 col-sm-4">
								<div class="form-group">
										...
										{!! Form::select('ruta',$rutas,$ruta, $attributes = array('class'=>'form-control','id'=>'ruta')) !!}
						...
						<div class="row">
							<div class="col-lg-4 col-sm-4">
								<div class="form-group">
										<label>Sesion</label>
										<input type="text" name="session" value="{{$menuitem->session}}" class="form-control" id="session" placeholder="Sesion...">
								</div>
							</div>
						</div>
						<div class="row">
							<div class="col-lg-4 col-sm-4">
								<div class="form-group">
										...
										{!! Form::select('imagen',$iconos[1],$icono, $attributes = array('class'=>'form-control','id'=>'imagen')) !!}
										<i id="iconoseleccionado"class="fa {{$iconos[1][$icono]}}"></i>
