...
?>
                            <a href="{{asset('/admin/listarAnunciosProgramados')}}">
                                <i class="menu-icon fa fa-caret-right">
                                </i>
...
?>
                            <a href="{{ asset('/admin/listarPendienteReferidos')}}">
                                <i class="menu-icon fa fa-caret-right">
                                </i>
                                Pendiente de cobro
                            </a>
...
?>
                            <a href="{{asset('/admin/getUserFacturas')}}">
                                <i class="menu-icon fa fa-caret-right">
                                </i>
                                Facturas
                            </a>
...
?>
                            <a href="{{ asset('admin/PendienteFacturar')}}">
                                <i class="menu-icon fa fa-caret-right">
                                </i>
                                Facturacion
                            </a>
...
?>
                            <a href="{{ asset('admin/getAllFacturas')}}">
                                <i class="menu-icon fa fa-caret-right">
                                </i>
                                Listado Facturas
                            </a>
...
?>
                            <a href="{{asset('/admin/GetFacturasPagar')}}">
                                <i class="menu-icon fa fa-caret-right">
                                </i>
                                Realizar Pagos
                            </a>
