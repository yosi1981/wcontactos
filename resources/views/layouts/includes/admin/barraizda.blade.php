...
<?php $seccion = \Session::get('seccion_actual');if ($seccion === "editincludecss") {echo "<li class='active open' style='text-align: left;'>";} else {echo "<li style='text-align: left;'>";}?><a href="{{URL::to('/admin/editincludesstyles')}}">
...
<?php $seccion = \Session::get('seccion_actual');if ($seccion === "editincludescripts") {echo "<li class='active open' style='text-align: left;'>";} else {echo "<li style='text-align: left;'>";}?><a href="{{URL::to('/admin/editincludescripts')}}">
...
<?php $seccion = \Session::get('seccion_actual');if ($seccion === "asdf") {echo "<li class='active open' style='text-align: left;'>";} else {echo "<li style='text-align: left;'>";}?><a href="{{URL::to('afsdf')}}">
