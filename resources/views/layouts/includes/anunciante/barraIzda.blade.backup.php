...
?>
                                <a href="{{asset('/anunciante/paquete')}}">
...
?>
                      <a class="" href="{{asset('/anunciante/Imagen')}}">
                          <i class="menu-icon fa fa-tachometer">
                          </i>
                          <span class ="menu-text">
                          Imagen
...
?>
                                <a href="{{asset('/anunciante/listarAnunciosProgramados')}}">
                                    <i class="menu-icon fa fa-caret-right">
                                    </i>
...
?>
                      <a class="" href="{{asset('/anunciante/infocuenta')}}">
                          <i class="menu-icon fa fa-tachometer">
                          </i>
                          <span class ="menu-text">
                          Info Cuenta
...
?>
                      <a class="" href="{{asset('/anunciante/ContratarDias')}}">
                          <i class="menu-icon fa fa-tachometer">
                          </i>
                          <span class ="menu-text">
                          Contratar dias
...
?>
                                ...
                                <a href="{{ asset('/anunciante/listarPendienteReferidos')}}">
                                    <i class="menu-icon fa fa-caret-right">
                                    </i>
                                    Pendiente de cobro
                                </a>
...
?>
                                <a href="{{asset('/anunciante/getUserFacturas')}}">
                                    <i class="menu-icon fa fa-caret-right">
                                    </i>
                                    Facturas
                                </a>
