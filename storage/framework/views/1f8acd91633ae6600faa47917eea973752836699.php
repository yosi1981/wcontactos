                ...
                <?php $__currentLoopData = $paquetes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $paquete): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <tr>
                        ...
                        <div class="progress  progress-striped active">
                                                    <div class="progress-bar progress-bar-success" style="width: <?php echo e(count($paquete->Usos)*100/$paquete->dcontratados); ?>%;"><?php echo e(count($paquete->Usos)); ?>/<?php echo e($paquete->dcontratados); ?>&nbsp;(<?php echo e(count($paquete->Usos)*100/$paquete->dcontratados); ?>%)</div>
                                                    <div class="progress-bar progress-bar-warning" style="width: <?php echo e(($paquete->dcontratados - count($paquete->Usos))*100/$paquete->dcontratados); ?>%;"><?php echo e($paquete->dcontratados - count($paquete->Usos)); ?>/<?php echo e($paquete->dcontratados); ?>&nbsp;(<?php echo e(($paquete->dcontratados - count($paquete->Usos))*100/$paquete->dcontratados); ?>%)</div>
                        </div>
