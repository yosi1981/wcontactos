	...
	<div class="breadcrumbs ace-save-state" id="breadcrumbs">
                        <div class="widget-body" style="display: block;">
                            ...
                            <div class="widget-main">
																...
																<!-- <label>Id Menu</label>  -->
																<input type="hidden" name="idmenu" class="form-control"  value="<?php echo e($idmenu); ?>" id="idmenu" placeholder="idprovincia...">
																<!-- <label >Id Menu Padre</label>  -->
																<input type="hidden" id="idmenuitem_padre" name="idmenuitem_padre"  class="form-control" value="<?php echo e($idmenupadre); ?>" placeholder="Nombre...">
											<div class="row">
		...
		<div class="row">
			<div class="col-lg-4 col-sm-4">
				<div class="form-group">
					...
					<?php echo Form::select('Ruta',$rutas,null, $attributes = array('class'=>'form-control','id'=>'ruta')); ?>
      ...
      <?php echo Form::select('imagen',$iconos[1],null, $attributes = array('class'=>'form-control','id'=>'imagen')); ?>

       <i id="iconoseleccionado" class="fa <?php echo e($iconos[1][0]); ?>">
        	</i>
