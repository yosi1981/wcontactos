...
<?php if(session()->has('msj')): ?>
                    ...
                    <div class="widget-box widget-color-blue ui-sortable-handle" id="widget-box-3">
                        ...
                        <div class="breadcrumbs ace-save-state" id="breadcrumbs">
                            <a href="<?php echo e(URL::to('/anunciante/crearAnuncio')); ?>" padding-left="15px">
                            ...
                            <div class="nav-search" id="nav-search">
                                <?php echo Form::open(array('url'=>'/anunciante/Anuncio','method'=>'GET','class'=>'form-search','autocomplete'=>'off','role'=>'search')); ?>
                                                ...
                                                <td>
                                                    <div class="hidden-sm hidden-xs btn-group">
                                                        <button class="btn btn-sm btn-success">
                                                            <a href="<?php echo e(URL::to('/anunciante/AnuncioA/'.$anu->idanuncio.'/edit')); ?>">
                        ...
                        <?php if($anu->activo == 1): ?>
                                                        <button class="btn btn-sm btn-warning">
                                                            <a href="<?php echo e(URL::to('/anunciante/listadoCitas/'.$anu->idanuncio)); ?>">
                                                        ...
                                                        <?php endif; ?>
                                                        <button class="btn btn-sm btn-warning">
                                                            <a href="<?php echo e(URL::to('/anunciante/createAP/'.$anu->idanuncio)); ?>">
                                                                <i class="ace-icon fa fa-calendar bigger-120">
                                                                </i>
                                                            </a>
                                                        </button>
...
<script type="text/javascript">
    $('#searchText').on('keyup',function(){
        ...
        $.ajax({
            type : 'get',
            url  : "<?php echo e(URL::to('/anunciante/searchAnuncio')); ?>",
...
$(document).ready(function() {
    ...
    {
        var url="<?php echo e(URL::to('/anunciante/searchAnuncio')); ?>";
        $.ajax({
            type : 'get',
            url  : url+'?page='+page,
        ...
        $('.modal-footer').on('click', '.delete', function(e) {
            e.preventDefault();
            var url="<?php echo e(URL::to('/anunciante/eliminarAnuncio')); ?>";
