			...
			<div class="modal-content">
				...
				<form action="/admin/actualizarlocalidad" method "post" id="frmEditPoblacion">
						<div class="row">
							<div class="col-lg-4 col-sm-4">
								<div class="form-group">
										<input type="hidden" name="idlocalidad" class="form-control" value="<?php echo e($poblacion->idlocalidad); ?>" id="idlocalidad">
								</div>
							</div>
						</div>
						<div class="row">
						...
						<div class="row">
								<div class="col-lg-4 col-sm-4">
									<div class="form-group">
										<input type="hidden" id="idprovincia" name="idprovincia" class="form-control" value="<?php echo e($poblacion->idprovincia); ?>" >
									</div>
								</div>
						</div>
				</div>
